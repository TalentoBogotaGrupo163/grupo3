...
class UniversityXCitiesTest < ApplicationSystemTestCase
  ...
  test "creating a University x city" do
    ...
    fill_in "Code City", with: @university_x_city.code_city_id
    fill_in "Code University", with: @university_x_city.code_university_id
    fill_in "Description", with: @university_x_city.description
