...
class BenefitXUniversitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create benefit_x_university" do
    assert_difference('BenefitXUniversity.count') do
      post benefit_x_universities_url, params: { benefit_x_university: { code_benefit_id: @benefit_x_university.code_benefit_id, code_university_id: @benefit_x_university.code_university_id, description: @benefit_x_university.description } }
    end
  ...
  test "should update benefit_x_university" do
    patch benefit_x_university_url(@benefit_x_university), params: { benefit_x_university: { code_benefit_id: @benefit_x_university.code_benefit_id, code_university_id: @benefit_x_university.code_university_id, description: @benefit_x_university.description } }
