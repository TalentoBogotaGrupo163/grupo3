...
class BenefitXUniversitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create benefit_x_university" do
    assert_difference('BenefitXUniversity.count') do
      post benefit_x_universities_url, params: { benefit_x_university: { Benefit_id: @benefit_x_university.Benefit_id, University_id: @benefit_x_university.University_id, description: @benefit_x_university.description } }
    end
  ...
  test "should update benefit_x_university" do
    patch benefit_x_university_url(@benefit_x_university), params: { benefit_x_university: { Benefit_id: @benefit_x_university.Benefit_id, University_id: @benefit_x_university.University_id, description: @benefit_x_university.description } }
