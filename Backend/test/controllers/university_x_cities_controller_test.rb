...
class UniversityXCitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create university_x_city" do
    assert_difference('UniversityXCity.count') do
      post university_x_cities_url, params: { university_x_city: { city_id: @university_x_city.city_id, university_id: @university_x_city.university_id } }
    end
  ...
  test "should update university_x_city" do
    patch university_x_city_url(@university_x_city), params: { university_x_city: { city_id: @university_x_city.city_id, university_id: @university_x_city.university_id } }
