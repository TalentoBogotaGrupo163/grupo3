...
class UniversityXCitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create university_x_city" do
    assert_difference('UniversityXCity.count') do
      post university_x_cities_url, params: { university_x_city: { City_id: @university_x_city.City_id, University_id: @university_x_city.University_id, description: @university_x_city.description } }
    end
  ...
  test "should update university_x_city" do
    patch university_x_city_url(@university_x_city), params: { university_x_city: { City_id: @university_x_city.City_id, University_id: @university_x_city.University_id, description: @university_x_city.description } }
