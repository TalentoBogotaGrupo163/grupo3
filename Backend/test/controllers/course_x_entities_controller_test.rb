...
class CourseXEntitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_x_entity" do
    assert_difference('CourseXEntity.count') do
      post course_x_entities_url, params: { course_x_entity: { Courses_id: @course_x_entity.Courses_id, Entity_id: @course_x_entity.Entity_id, description: @course_x_entity.description } }
    end
  ...
  test "should update course_x_entity" do
    patch course_x_entity_url(@course_x_entity), params: { course_x_entity: { Courses_id: @course_x_entity.Courses_id, Entity_id: @course_x_entity.Entity_id, description: @course_x_entity.description } }
