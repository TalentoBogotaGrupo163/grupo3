...
class CourseXEntitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_x_entity" do
    assert_difference('CourseXEntity.count') do
      post course_x_entities_url, params: { course_x_entity: { course_id: @course_x_entity.course_id, description: @course_x_entity.description, entity_id: @course_x_entity.entity_id } }
    end
  ...
  test "should update course_x_entity" do
    patch course_x_entity_url(@course_x_entity), params: { course_x_entity: { course_id: @course_x_entity.course_id, description: @course_x_entity.description, entity_id: @course_x_entity.entity_id } }
