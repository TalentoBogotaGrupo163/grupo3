...
class ActivitiesXSubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create activities_x_subject" do
    assert_difference('ActivitiesXSubject.count') do
      post activities_x_subjects_url, params: { activities_x_subject: { code_activity_id: @activities_x_subject.code_activity_id, code_subject_id: @activities_x_subject.code_subject_id, description: @activities_x_subject.description } }
    end
  ...
  test "should update activities_x_subject" do
    patch activities_x_subject_url(@activities_x_subject), params: { activities_x_subject: { code_activity_id: @activities_x_subject.code_activity_id, code_subject_id: @activities_x_subject.code_subject_id, description: @activities_x_subject.description } }
