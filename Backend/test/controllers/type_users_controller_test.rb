...
class TypeUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type_user" do
    assert_difference('TypeUser.count') do
      post type_users_url, params: { type_user: { code_type: @type_user.code_type, name_type: @type_user.name_type } }
    end
  ...
  test "should update type_user" do
    patch type_user_url(@type_user), params: { type_user: { code_type: @type_user.code_type, name_type: @type_user.name_type } }
