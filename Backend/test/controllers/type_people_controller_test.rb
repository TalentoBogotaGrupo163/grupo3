...
class TypePeopleControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type_person" do
    assert_difference('TypePerson.count') do
      post type_people_url, params: { type_person: { code_type: @type_person.code_type, name_type: @type_person.name_type } }
    end
  ...
  test "should update type_person" do
    patch type_person_url(@type_person), params: { type_person: { code_type: @type_person.code_type, name_type: @type_person.name_type } }
