...
class NotesXSubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notes_x_subject" do
    assert_difference('NotesXSubject.count') do
      post notes_x_subjects_url, params: { notes_x_subject: { Notes_id: @notes_x_subject.Notes_id, Subjects_id: @notes_x_subject.Subjects_id, description: @notes_x_subject.description } }
    end
  ...
  test "should update notes_x_subject" do
    patch notes_x_subject_url(@notes_x_subject), params: { notes_x_subject: { Notes_id: @notes_x_subject.Notes_id, Subjects_id: @notes_x_subject.Subjects_id, description: @notes_x_subject.description } }
